...
void loop() {
  ...
  if (cm_left < 10 && cm_right < 10) {
    ...
    A_cclock();
    B_cclock();
  } else if (cm_left >= 10 && cm_left < 25 && cm_right >= 10 && cm_right < 25) {
    Serial.println("Forword");
    A_clock();
    B_clock();
  } else if (cm_left >= 10 && cm_left < 25 && cm_right >= 25) {
    Serial.println("Turn Right");
    A_clock();
    B_cclock();
  } else if (cm_left >= 25 && cm_right >= 10 && cm_right < 25) {
