...
float d = 5.0, offset_w[3] = { 0.0f, 90.0f, -90.0f }, offset_h = 0.0f;  // 到旋轉中心的距離還有offset
...
void loop() {
  ...
  int Yaw_pos[3], Pitch_pos;
  Pitch_pos = -1 * (SMA_P - offset_h) / DegreePerPixel_h;

  Yaw_pos[0] = (SMA_Y - offset_w[0]) / DegreePerPixel_w;
  oled.setCursor(Yaw_pos[0], Pitch_pos);  //設定文字位址
  oled.setTextColor(OLED_Color_White);    //文字顏色為白
  oled.print("N");
  oled.setCursor(Yaw_pos[0], Pitch_pos);  //設定文字位址
  ...
  Yaw_pos[1] = (SMA_Y - offset_w[1]) / DegreePerPixel_w;
  oled.setCursor(Yaw_pos[1], Pitch_pos);  //設定文字位址
  oled.setTextColor(OLED_Color_White);    //文字顏色為白
  oled.print("Team 2");
  oled.setCursor(Yaw_pos[1], Pitch_pos);  //設定文字位址
  oled.setTextColor(OLED_Color_Black);    //文字顏色為黑
  ...
  Yaw_pos[2] = (SMA_Y - offset_w[2]) / DegreePerPixel_w;
  oled.setCursor(Yaw_pos[2], Pitch_pos);  //設定文字位址
  oled.setTextColor(OLED_Color_White);    //文字顏色為白
  oled.print("E24094164");
  oled.setCursor(Yaw_pos[2], Pitch_pos);  //設定文字位址
  oled.setTextColor(OLED_Color_Black);    //文字顏色為黑
  oled.print("E24094164");
}